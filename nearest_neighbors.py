...
def main(args):
    ...
    model.load_state_dict(torch.load("/home/khaled/Uni/Deep_Learning_Lab/lr0.0005_bs64__local/models/ckpt_epoch9.pth",
                                     map_location=torch.device('cuda')), strict=False)    # raise NotImplementedError("TODO: build model and load weights snapshot")

    # dataset
    data_root = '/home/khaled/Uni/Deep_Learning_Lab/cv_assignment/data'
    ...
    log = SummaryWriter(
        "/home/khaled/Uni/Deep_Learning_Lab/cv_assignment/tensorboard")
